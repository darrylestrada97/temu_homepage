          ...
          <HStack spacing={8} alignItems={'center'}>
            <MotionBox whileHover={{ scale: 1.2 }} rounded="full">
              <NextLink href={'/'} passHref>
                {linkColor === 'accent.500' ? (
                  <Avatar as={Link} backgroundColor={'transparent'} src={'/bsc_dark.gif'} />
                ) : (
                  <Avatar as={Link} backgroundColor={'transparent'} src={'/bsc_light.gif'} />
                )}
              </NextLink>
            </MotionBox>
