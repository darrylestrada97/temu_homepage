...
export const newContent = [
  {
    link: 'https://temu.bsc.es/clinspen/',
    text: 'Biomedical WMT | ClinSpEn',
    showNewTag: true
  },
  {
    link: 'https://temu.bsc.es/socialdisner/',
    text: 'SocialDisNER – Detection of disease mentions in tweets ',
    showNewTag: false
  },
  {
